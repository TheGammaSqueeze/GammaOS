...
- Unisoc Drivers - run the DPInst64.exe program in your relevant OS folder, (Win10 drivers will also work on Win11) https://github.com/TheGammaSqueeze/GammaOS/blob/main/UnisocDrivers.zip
